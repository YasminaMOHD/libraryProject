...
<main>
    ...
    <div class="container tittle">
        <p class="page-tittle">مكتبة اقرأ / <span> تعديل بيانات دار النشر</span></p>
    </div>
        ...
        <div class="row">
            <div class="col-12">
                @foreach($publisher as $pub)
                    <form method="post" enctype="multipart/form-data" action="{{url('publisher/update/'.$pub->id)}}">
                        @csrf

                        <div class="mb-4 col-12">
                            <label for="exampleInputEmail1" class="form-label">اسم المؤلف</label>
                            <input type="text" class="form-control" name="name" value="{{$pub->name}}" id="exampleInputEmail1" aria-describedby="emailHelp">
                        ...
                        <div class="mb-4  col-12">
                            ...
                            <div class="form-floating">
                                <textarea class="form-control" name="info"   id="floatingTextarea2" style="height: 100px">{{$pub->info}}</textarea>
                            </div>
                        ...
                        <div class="mb-4 row col-12">
                            <div class="col-md-12">
                                <button type="submit" name="submit" class="btn btn-primary col-12">تحديث معلومات دار النشر</button>
                            </div>
                        </div>
                    </form>
                @endforeach
