...
<div class="container tittle">
    <p class="page-tittle">مكتبة اقرأ / <span> إضافة دار نشر</span></p>
</div>
...
<div class="container">
    ...
    <div class="row">
        <div class="col-12">
            <form method="post" action="{{url('publisher/store')}}">
                @csrf
                <div class="mb-4 col-12">
                    <label for="exampleInputEmail1" class="form-label">اسم دار النشر</label>
                ...
                <div class="mb-5 row col-12">
                    <div class="col-md-12 w-100">
                        <label for="exampleInputPassword1" class="form-label">معلومات عن دار النشر</label>
                    ...
                    <div class="mb-4 row col-12">
                        <div class="col-md-12">
                            <button type="submit" class="btn btn-primary col-12">إضافة دار النشر</button>
                        </div>
                    </div>
            </form>
        </div>
