...
<div class="container tittle">
    <p class="page-tittle">مكتبة اقرأ / <span> إضافة تصنيف</span></p>
</div>
            ...
            <form method="post" action="{{url('category/store')}}">
                ...
                <div class="mb-5 row col-12">
                    <div class="col-md-12 w-100">
                        <label for="exampleInputPassword1" class="form-label">معلومات عن التصنيف</label>
                    ...
                    <div class="mb-4 row col-12">
                        <div class="col-md-12">
                            <button type="submit" class="btn btn-primary col-12">إضافة التصنيف</button>
                        </div>
                    </div>
            </form>
        </div>
